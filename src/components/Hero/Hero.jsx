      ...
      <div className="relative container" ref={parallaxRef}>
        ...
        mb-[4rem] md:mb-20 lg:mb:[6rem]">
          <h1 className="h1 mb-6">
            Redefine Communication with  AI Powered &nbsp;
            <span className="inline-block relative">Neuron
              <img
                alt="Curve"
                src={curve}
                className="top-full absolute left-0 w-full xl:-mt-2"
                width={624}
                height={28}
              />
            </span>
          ...
          text-n-2 lg:mb-8">
            Experience smarter, faster communication with Neuron&apos;s AI.
            Unlock new possibilities through personalized and intuitive conversations.
          </p>
